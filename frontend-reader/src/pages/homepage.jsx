                ...
                <div className='h-full w-full flex flex-col justify-center items-start gap-[25px]'>
                  ...
                  <button 
                    onClick={() => {
                        setSignupHeading("Join Wordloom.");
                        setShowSignup(true);}}
                    className='lg:text-[1.4vw] text-[1.7vh] font-medium bg-neutral-700 lg:w-[13vw] w-[17vh] p-[1vh] rounded-4xl text-zinc-100 cursor-pointer hover:bg-neutral-800 motion-preset-seesaw-sm'>
                      Start reading
                  </button>
                </div>
